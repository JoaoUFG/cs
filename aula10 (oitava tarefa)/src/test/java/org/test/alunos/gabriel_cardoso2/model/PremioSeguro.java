...
public class PremioSeguro {
	...
	public Double getValorSeguroComDesconto() {
		return valorSeguroComDesconto;
	}
	public void setValorSeguroComDesconto(Double valorSeguroComDesconto) {
		this.valorSeguroComDesconto = valorSeguroComDesconto;
	}
