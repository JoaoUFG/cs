package org.test.alunos.amanda;
...
public class PremioSeguroTest {
    ...
    public void testaFemininoSolteira18A25(){
        ...
        //Double desconto = premioSeguro.obtemPercentualDesconto();//erro
        premioSeguro.obtemPercentualDesconto();
        //Assert.assertEquals(desconto, esperado);//
        assertEquals(premioSeguro.getPercentualDesconto(), esperado);
    }
...
//todos os métodos foram implementados de forma errada.
